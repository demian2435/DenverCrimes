...
public class FXMLController {
	...
	@FXML // fx:id="boxMese"
	private ComboBox<YearMonth> boxMese; // Value injected by FXMLLoader
	...
	void doCreaGrafo(ActionEvent event) {
		txtResult.clear();
		YearMonth date = boxMese.getValue();
		String category = boxCategoria.getValue();

		List<Event> result = model.getEventsFromDateAndCategory(date, category);
	...
	public void setModel(Model model) {
		...
		boxCategoria.getSelectionModel().selectFirst();
		boxMese.getItems().addAll(model.getDate());
